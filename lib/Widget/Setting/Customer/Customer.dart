...
import 'package:stm_report_app/Widget/Setting/Customer/CustomerView.dart';
...
class _CustomerState extends State<Customer> {
  Future<List<CustomerModel>> initData() async {
  ...
  Future<List<CustomerModel>>? InitData;
  ...
  void onClickView(CustomerModel customerModel) async {
    var result = await Navigator.push(
      context,
      MaterialPageRoute(
  ...
  void onClickDelete(String code) async {
    ...
    if (prompt) {
      var body = CustomerModel(code: code).toJson();
