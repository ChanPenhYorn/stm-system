...
class CompanyEdit extends StatefulWidget {
  ...
  CompanyEdit({Key? key, required this.companyModel}) : super(key: key);
...
class _CompanyEditState extends State<CompanyEdit> {
  ...
  void initState() {
    ...
    companyNameCon.text = widget.companyModel.name ?? "";
    companyDescCon.text = widget.companyModel.description ?? "";
    companyPhoneNumberCon.text = widget.companyModel.phoneNumber ?? "";
    companyAddressCon.text = widget.companyModel.address ?? "";
    super.initState();
  }

  TextEditingController companyNameCon = TextEditingController();
  TextEditingController companyDescCon = TextEditingController();
  TextEditingController companyPhoneNumberCon = TextEditingController();
  TextEditingController companyAddressCon = TextEditingController();
  String logoBase64 = "";
  File? imageProfile;
  ...
  onClickSubmit() async {
    ...
    if (available) {
      ...
      if (prompt) {
        var body = CompanyModel(
          code: widget.companyModel.code!,
          name: companyNameCon.text.trim(),
          description: companyDescCon.text.trim(),
          address: companyAddressCon.text.trim(),
          phoneNumber: companyPhoneNumberCon.text.trim(),
          logo: logoBase64,
        ).toJson();
        var res = await Singleton.instance.apiExtension.post<String, String>(
            context: context,
            loading: true,
            baseUrl: ApiEndPoint.companyUpdate,
            body: body,
          ...
          child: Container(
            ...
            child: Form(
              ...
              child: ListView(
                ...
                children: [
                  Text(
                    'Navigation.CompanyEntity.Info'.tr(),
                              ...
                              Expanded(
                                child: TextFormField(
                                  ...
                                  autovalidateMode:
                                      AutovalidateMode.onUserInteraction,
                                  style: StyleColor.textStyleKhmerContent,
                                  controller: companyPhoneNumberCon,
                                  decoration: InputDecoration(
                                    errorStyle:
                                        StyleColor.textStyleKhmerContent12Red,
                                    focusedBorder: OutlineInputBorder(
