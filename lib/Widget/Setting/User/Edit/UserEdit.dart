...
class _UserEditState extends State<UserEdit> {
  ...
  void initState() {
    ...
    userNameCon.text = widget.userModel.username ?? "";
  ...
  initRole() async {
    listRole = widget.userModel.role!;
  }
  ...
  onClickSubmit() async {
    ...
    if (available && listRole.length > 0) {
      ...
      if (prompt) {
        ...
        widget.userModel.methodType = "update";
  ...
  Widget buildRoleChip() {
    ...
    if (listChip.length > 0)
      ...
      return Container(
        ...
        child: Text(
          'Message.NoHaveRolePermission'.tr(),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(
            'Navigation.EditRolePermission'.tr(),
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                child: TextFormField(
                                  validator: (value) {
                                    RegExp regExp = RegExp(r"[a-zA-Z1-9]");
                                    if (value!.isEmpty) {
                                      return "Message.PleaseInputUsername".tr();
